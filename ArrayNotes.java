...
public class ArrayNotes
{
    ...
    public static void createArrayOfOdds()
    {
        ...
        // the 'new' part is optional when using array literals
        ...
        for(int odd : odds)
        {
            //odd = 1;  // enhanced for loops cannot directly alter an array's values
    ...
    public static void createArrayOfCalendars()
    {
        ...
        // at this point, every element in the array has avalue of null
        ...
        /*
         * Create new calendar objects and assign their references to each element in the array
         */
        ...
        /*
         * An enhanced for loop cannot modify the value of the elements in the array (e.g., references to calendar object),
         *      but we can call mutator methods which modify the properties of the referenced objects (e.g., day of the month)
         */
        for(GregorianCalendar calendar : calendars)
        {
